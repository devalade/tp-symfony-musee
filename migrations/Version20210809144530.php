 ...
 */
final class Version20210809144530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4690D34DCC1CF4E6 ON bibliotheque (isbn)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_4690D34DCC1CF4E6 ON bibliotheque');
